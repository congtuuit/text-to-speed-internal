...
npx concurrently -k -n "Backend,Frontend" -c "bgBlue.bold,bgMagenta.bold" "cd backend && . venv/bin/activate && uvicorn main:app --host 0.0.0.0 --port 8000 --reload" "cd frontend && npm run dev"
