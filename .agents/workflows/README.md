...
| `/pm-pro` | **PM Thực chiến (Nam)** ⭐ NEW | Phản biện logic, Roadmap thực tế, Rủi ro |
| `/expert-code` | **Senior Dev Lead (Sơn)** ⭐ NEW | Architecture, Clean Code, Performance |
...
| `/pm-pro` | Nam (Strategic PM) | Thẳng thắn, logic, "Tại sao?" |
| `/expert-code` | Sơn (Architect) | Khắt khe, tối ưu, hệ thống |
